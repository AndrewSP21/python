...
def division(num1, num2):
    try:
        ...
        return num1 + ' / ' + num2 + ' не корректно' # У меня не получилось создать ситуацию, когда возникает это исключение.
                                                       # Если ввести букву, то приложение падает с ошибкой.
...
def get_square_two_max_values(a, b, c):
    z = [a, b, c]
    z.remove(min(a, b, c)) # Красивее так:  z.remove(min(z))
    return sum(z)
...
user_sum_numbers()
# Красивое и простое решение, молодец!
